...
export default function InterchangeAnimation() {
    ...
    function animateOne() {
        ...
        function animateRandomSequence(sequenceId) {
            ...
            const randomLetter =
                availableLetterNumbers[Math.floor(Math.random() * availableLetterNumbers.length)]
            ...
            tl.call(() => {
                ...
                if (sourceElement) {
                    ...
                    sourceTl
                        ...
                        .set(
                            pathElements.length > 0 ? `${sourceSelector} path` : sourceSelector,
                            {
                                fill: appColor,
                                attr: { fill: appColor },
                            },
            ...
            tl.to(numElementSelector, {
                ...
                .to(
                    ...
                    '-=0.15'
                ) // Start fade out 0.15s before path completes, so it ends when path ends
                ...
                <g id="Group 1621">
                    <g id="Group 1609">
                        ...
                        <path
                            ...
                            fill="currentColor"
                        />
                        <g id="Frame" opacity="0.65" clipPath="url(#clip0_9648_2949)">
                            <path
                                id="Vector_17"
                        ...
                        <path
                            ...
                            fill="currentColor"
                        />
                        <g id="Frame_3" opacity="0.65" clipPath="url(#clip2_9648_2949)">
                            <path
                                id="Vector_41"
                        ...
                        <path
                            ...
                            fill="currentColor"
                        />
                        <g id="Frame_4" opacity="0.65" clipPath="url(#clip3_9648_2949)">
                            <path
                                id="Vector_46"
