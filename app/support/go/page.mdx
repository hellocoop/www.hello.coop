...
To remove a GitHub Org from Hellō, complete all three steps below.
...
This removes the offboarding data for your GitHub org from Hellō Lifecycle. Automated offboarding will stop working for this org.
...
### Step 2: Delete the Hello-Lifecycle Repository
...
### Step 3: Uninstall the Hellō GitHub App
