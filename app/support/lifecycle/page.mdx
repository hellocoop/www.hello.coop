...
1. Go to your repository settings:
   ...
   ```
   <OrgLink path="<ORG>/Hello-Lifecycle/settings" label="repository settings" />
...
**Google:**
1. Open [Google Domain-wide Delegation](https://admin.google.com/ac/owl/domainwidedelegation).
2. Find **Hellō Lifecycle**.
3. Click **Delete** to revoke all access.

**Microsoft:**
1. Open [Microsoft Enterprise Applications](https://entra.microsoft.com/#view/Microsoft_AAD_IAM/StartboardApplicationsMenuBlade/~/AppAppsPreview).
2. Find **Hellō Lifecycle**.
