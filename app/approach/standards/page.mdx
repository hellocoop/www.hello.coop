...
Hellō's founder, [Dick Hardt](https://www.linkedin.com/in/dickhardt/), has been at the forefront of internet identity standards since the early 2000s. He co-founded the [OpenID Foundation](https://openid.net/foundation/) and led the design of two foundational technologies:  
[OAuth 2.0](https://datatracker.ietf.org/doc/rfc6749/) and JSON Web Token (JWT) — standards used by billions of people every day.
...
The AAuth specifications are maintained in the [AAuth repository](https://github.com/dickhardt/AAuth), and more background, explainers, and community resources are at [aauth.dev](https://www.aauth.dev).

- [AAuth Protocol](https://datatracker.ietf.org/doc/draft-hardt-oauth-aauth-protocol)
- [HTTP Signature Keys](https://datatracker.ietf.org/doc/draft-hardt-httpbis-signature-key)
- [AAuth Bootstrap Guidance](https://datatracker.ietf.org/doc/draft-hardt-aauth-bootstrap)
- [AAuth Events](https://dickhardt.github.io/AAuth/draft-hardt-aauth-events.html)

Dick is the author of the AAuth family of specifications.

## Email Verification
Verifying control of an email is a hassle for users, and is a source of friction for web sites. Email Verification allows a user to prove they control an email address without leaving the website.

Dick is one of the authors of:

- [Email Verification Protocol](https://datatracker.ietf.org/doc/draft-hardt-email-verification)
- [Email Verification API](https://github.com/WICG/email-verification-protocol)
- [Chrome Origin Trial](https://developer.chrome.com/origintrials/#/view_trial/10696049115004929)
- [Edge Origin Trial](https://developer.microsoft.com/en-us/microsoft-edge/origin-trials/trials/683027d2-a798-460f-9b35-03a95002d9af)

## Protected Resources
#### OAuth Protected Authorization

OAuth Protected Authorization defines browser support for protecting OAuth authorization requests and responses in redirect-based flows.

Dick is the author of [OAuth Protected Authorization](https://datatracker.ietf.org/doc/draft-hardt-oauth-protected-authorization).
