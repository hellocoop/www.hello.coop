...
### 1) What if Hellō is subpoenaed to provide information about a user?</summary>
...
### 2) What if Hellō's infrastructure vendor (eg AWS) is subpoenaed to exfiltrate user data from machines running one of the components?</summary>
...
### 3) How will Hellō operate in regimes that require access to user information?</summary>
...
### 4) How will you operate in China if you do not provide access to user information?</summary>
