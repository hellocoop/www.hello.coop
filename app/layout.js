        ...
        <html lang="en" suppressHydrationWarning>
            <Head>
                ...
                <meta
                    ...
                    content="Goodbye SSO tax. Hyperscale security for all."
                />
                ...
                <meta
                    ...
                    content="https://cdn.hello.coop/images/og-preview.png"
                />
                {/* Favicons */}
                <link
            ...
            <body className="bg-white text-charcoal dark:bg-[#151515] dark:text-gray overflow-x-hidden font-sans">
                <Plausible />
                <Header />
                {children}
                <Footer />
