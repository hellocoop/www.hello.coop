...
The cooperative's board of directors represents member interests and periodically reviews the Hellō operations to ensure they are meeting the [Hellō Tenets](tenets), [Laws of Identity](laws-of-identity), and 
when deployed, the [Data Governance](data-governance). 
...
<details>
<summary>1) Why not a non-profit foundation?</summary>
...
<details>
<summary>2) Why aren't developers members?</summary>
...
<details>
<summary>3) What does the cooperative do with its membership fees?</summary>
...
<details>
<summary>4) Why are people using Hellō called "user members"?</summary>
