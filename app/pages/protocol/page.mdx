...
<p className="mt-4 gap-4 flex flex-row flex-wrap">
    <img src="/assets/legend-exampleapp.svg" alt="Signed by example.app" />
    <img src="/assets/legend-opexample.svg" alt="Signed by op.example" />
    <img src="/assets/legend-tokenservice.svg" alt="Signed by Token Service" />
    <img src="/assets/legend-storageservice.svg" alt="Signed by Storage Service" />
</p>
...
So far, we have provided each application the same identifier for the same user. To address this, we create a layer of abstraction with a Release Record that links the Hellō identifier with a new, [directed identifier](/pages/laws-of-identity.html#_4-directed-identity) specific to the application and user.
