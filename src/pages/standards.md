...
Dick Hardt is one of the co-chairs of the [IPSIE working group](https://openid.net/wg/ipsie/).
...
Dick Hardt is one of the authors [OpenID Enterprise Extensions](https://github.com/openid/connect-enterprise-extensions)
...
Dick Hardt is one of the authors of [OPC](https://github.com/openid/openid-provider-commands)
...
Dick Hardt is one of the authors of [OpenID Connect Key Binding](https://github.com/openid/connect-key-binding)
