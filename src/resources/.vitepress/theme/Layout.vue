    ...
    <template #layout-bottom>
      <footer class="footer">
        <div class="footer-content">
          ...
          <div class="footer-column">
            <span class="footer-title">Dev Resources</span>
            <ul class="footer-list">
              <li>
                <a href="https://hello.dev/" target="_blank" class="ext-link-icon">Developer Docs</a>
              </li>
              <li>
                <a href="https://console.hello.coop/" target="_blank" class="ext-link-icon">
                  Developer Console
                </a>
              </li>
              <li>
                <a href="https://playground.hello.dev/" target="_blank" class="ext-link-icon">Playground</a>
              </li>
              <li>
                <a href="https://www.hello.dev/docs/admin-mcp/" target="_blank" class="ext-link-icon">MCP
                  Server</a>
              </li>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-list">
              ...
              <li>
                <a href="https://blog.hello.coop/" target="_blank" class="ext-link-icon">Hellō Blog</a>
              </li>
            </ul>
          </div>
            ...
            <ul class="footer-list">
              <li>
                <a href="https://hello-community.slack.com/join/shared_invite/zt-1eccnd2np-qJoOWBkHGnpxvBpCTtaH9g"
                  ...
                  <svg role="img" class="footer-icon" fill="currentColor" viewBox="0 0 24 24">
                    <title>Slack</title>
                    <path
              ...
              <li>
                <a href="https://www.linkedin.com/company/HelloCoop" target="_blank"
                  class="footer-social-link">
                  <svg class="footer-icon" fill="currentColor" role="img" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <title>LinkedIn</title>
                    <path
                      d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              ...
              <li>
                <a href="https://x.com/HelloCoop" target="_blank" class="footer-social-link">
                  <svg role="img" class="footer-icon-small" fill="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <title>X</title>
                    <path
              ...
              <li>
                <a href="https://www.youtube.com/@HelloCoop" target="_blank"
                  class="footer-social-link">
                  <svg role="img" class="footer-icon" viewBox="0 0 24 24" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg">
                    <title>YouTube</title>
                    <path
...
<style scoped>
  ...
  /* Footer styles - matching homepage exactly */
  .footer {
    display: flex;
    flex-direction: column;
    justify-content: center;
  ...
  @media (prefers-color-scheme: dark) {
    .footer-bottom {
      border-top-color: rgba(212, 212, 212, 0.15);
    }
  }
